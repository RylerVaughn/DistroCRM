...
exports.handler = async function (context, event, callback) {
  ...
  console.log("Message reached function.");

  try {
    await axios.post("https://2ba6-47-146-27-35.ngrok-free.app", event);
    console.log(`The messgage was posted successfuly.`);
  } catch(error) {
    console.log("Message failed to be posted.")
    callback(error);
  }
